class AddCachedVotesToQuestions < ActiveRecord::Migration[5.1]
 def self.up
  ...
  def self.down
    remove_column :quetions, :cached_votes_total
    remove_column :quetions, :cached_votes_score
    remove_column :quetions, :cached_votes_up
    remove_column :quetions, :cached_votes_down
    remove_column :quetions, :cached_weighted_score
    remove_column :quetions, :cached_weighted_total
    remove_column :quetions, :cached_weighted_average
  end
end